...
class ViewestudioController extends Controller
{
    ...
    /**
     * Displays a single Viewestudio model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Viewestudio model.
    ...
    /**
     * Updates an existing Viewestudio model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing Viewestudio model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Viewestudio model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the Viewestudio model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Viewestudio the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Viewestudio::findOne($id)) !== null) {
            return $model;
        } else {
