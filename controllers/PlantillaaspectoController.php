    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Crear nueva Plantilla aspecto",
                ...
                return [
                    ...
                    'title'=> "Crear nueva Plantilla aspecto",
                    'content'=>'<span class="text-success">Create Plantillaaspecto success</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Plantilla aspecto #".$id,
