    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Crear nueva Plantilla topografia",
                ...
                return [
                    ...
                    'title'=> "Crear nueva Plantilla topografia",
                    'content'=>'<span class="text-success">Create Plantillatopografia success</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Plantilla topografia #".$id,
