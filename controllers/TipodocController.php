    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Crear nuevo tipo de docmento",
                ...
                return [
                    ...
                    'title'=> "Crear nuevo tipo documento",
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar tipo de documento #".$id,
                ...
                return [
                 ...
                 return [
                    'title'=> "Actulizar Tipo de documento #".$id,
                    'content'=>$this->renderAjax('update', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
       ...
       try {
         $this->findModel($id)->delete();
           ...
           throw new \yii\web\HttpException(500,
               'No se puede eliminar la provincia porque esta asociado a uno o más pacientes',500);
