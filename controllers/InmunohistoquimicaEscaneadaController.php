...
class InmunohistoquimicaEscaneadaController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "InmunohistoquimicaEscaneada #".$id,
    ...
    public function actionCreate($id_biopsia)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new InmunohistoquimicaEscaneada",
                ...
                return [
                    ...
                    'title'=> "Create new InmunohistoquimicaEscaneada",
                    'content'=>'<span class="text-success">Create InmunohistoquimicaEscaneada success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing InmunohistoquimicaEscaneada model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing InmunohistoquimicaEscaneada model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    public function actionBulkDelete()
    {
        ...
        public function actionInforme($id) {
            $model=$this->findModel($id);
            // 'value'=> Html::a('<i class="fa fa-file-pdf-o"></i> Generar informe inmunostoquimica',  Url::to('@web/uploads/inmunohistoquimicas/'. $model->inmunohistoquimicaEscaneada->documento, true), [
            // return $this->redirect(['index']);
