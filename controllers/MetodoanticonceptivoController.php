    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new Metodoanticonceptivo",
                ...
                return [
                    ...
                    'title'=> "Create new Metodoanticonceptivo",
                    'content'=>'<span class="text-success">Create Metodoanticonceptivo success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update Metodoanticonceptivo #".$id,
