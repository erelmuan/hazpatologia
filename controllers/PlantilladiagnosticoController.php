...
class PlantilladiagnosticoController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "Plantilla diagnostico #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Crear nueva Plantilla diagnostico",
                ...
                return [
                    ...
                    'title'=> "Crear nueva Plantilla diagnostico",
                    'content'=>'<span class="text-success">Create Plantilladiagnostico success</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Plantilladiagnostico #".$id,
                ...
                return [
                 ...
                 return [
                    'title'=> "Actualizar Plantillad iagnostico #".$id,
                    'content'=>$this->renderAjax('update', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
