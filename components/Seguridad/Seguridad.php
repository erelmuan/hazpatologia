...
*/
    ...
    public static function tienePermiso($accion=''){
      ...
      foreach($rolesusuario as $roluser) {
            ...
            // return false;
            if ($accion =="fos" ||$accion =="puco"||$accion =="consulta"||$accion =="viewconsulta" || $accion =="informe" || $accion =="documento" || $accion=="perfil" ||  $accion=="search" ||  $accion=="subcat" ||  $accion=="buscaregistro")
               return true;
